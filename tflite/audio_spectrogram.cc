...
// Commented out for missing tflite micro features. #include
...
/* If the model used has more than one custom_op than please hook inside your
 * main.cpp */

void* Init(TfLiteContext* context, const char* buffer, size_t length) {
#ifdef _DEBUG
  context->ReportError(context, "==========In Init===================\n");
#endif
...
#ifdef _DEBUG
  context->ReportError(context, "==========Out Init===================\n");
#endif
  return data;
}
...
#ifdef _DEBUG
  context->ReportError(context, "==========In Free===================\n");
#endif
  auto* params = reinterpret_cast<TfLiteAudioSpectrogramParams*>(buffer);
  delete params->spectrogram;
  delete params;
#ifdef _DEBUG
  context->ReportError(context, "==========Out Free===================\n");
#endif
}

TfLiteStatus Prepare(TfLiteContext* context, TfLiteNode* node) {
#ifdef _DEBUG
  context->ReportError(context, "==========In Prepare===================\n");
#endif
  auto* params =
  ...
  TF_LITE_ENSURE_EQ(context, NumDimensions(output), 3);
  ...
  output->dims = output_size;
#ifdef _DEBUG
  context->ReportError(context, "==========Out Prepare===================\n");
#endif
  return kTfLiteOk;  // ctx-ResizeTensor not needed anymore, check flatbuffer
                     // compiler and provided model. Output_size is always 3!
}

template <KernelType kernel_type>
TfLiteStatus Eval(TfLiteContext* context, TfLiteNode* node) {
#ifdef _DEBUG
  context->ReportError(context, "==========In Eval===================\n");
#endif
  auto* params =
      reinterpret_cast<TfLiteAudioSpectrogramParams*>(node->user_data);
...
#ifdef _DEBUG
  context->ReportError(context, "==========Out Eval===================\n");
#endif
  return kTfLiteOk;
}
